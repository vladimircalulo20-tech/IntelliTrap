...
async function loadModel() {
    try {
        ...
        assessmentNote.textContent =
            "The AI model could not be loaded. Check the model URL and your internet connection.";
    }
}


// ==========================================
// IMAGE UPLOAD / SMARTPHONE CAMERA
// ==========================================
...
function handleImageUpload(event) {
    ...
    imageElement.alt = "Uploaded monitoring site image";
...
async function analyzeImage() {
    ...
    try {
        ...
        // Display assessment explanation
        const normalizedClassName = className.toLowerCase();

        const isPossibleBreedingSite =
            normalizedClassName.includes("possible") &&
            !normalizedClassName.includes("not");

        if (isPossibleBreedingSite) {
...
function saveAssessment() {
    ...
    // Remove empty message when adding the first record
    ...
    // Put newest assessment at the top
